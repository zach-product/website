                    ...
                    <nav style={navStyling} className='navbar navbar-expand-lg navbar-dark'>
                        <div className="container">
                            <a href="/" className="navbar-brand brand-font align-middle">
                                <img src={logo} width="40" length="40" alt="Zachary Pritchard" />
                            ...
                            <div className={`${classOne}`} id="navbarNav">
                                ...
                                <a class="btn btn-outline-light font-weight-bold float-right my-1" href="mailto:hello@prodforward.com" target="_blank" role="button">Subscribe</a>
                                </div>
                            </div>
                        </div>
                    </nav>                    
